...
subfolders, each full of images for each label. The example folder sampleImages
should have a structure like this:

~/sampleImages/daisy/photo1.jpg
~/sampleImages/daisy/photo2.jpg
...
~/sampleImages/rose/anotherphoto77.jpg
...
~/sampleImages/sunflower/somepicture.jpg
...
```bash
python tensorflow/examples/image_retraining/retrain.py \
    --image_dir ~/sampleImages --architecture mobilenet_1.0_224
```
